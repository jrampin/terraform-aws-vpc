...
| [aws_key_pair.terraform_key](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/key_pair) | resource |
...
|------|-------------|------|---------|:--------:|
| <a name="input_aws_account_id"></a> [aws\_account\_id](#input\_aws\_account\_id) | AWS Account ID | `string` | `"123456"` | no |
...
| <a name="output_s3_bucket_logs"></a> [s3\_bucket\_logs](#output\_s3\_bucket\_logs) | S3 Bucket for VPC logs |
